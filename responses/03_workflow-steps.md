...
### :keyboard: Activity: Store your credentials in GitHub secrets
...
3. Add a Build-Docker-Image job that waits for the build job to complete, then checks out the repository, downloads the build artifact, and uses the [mattdavis0351/actions/docker-gpr](https://github.com/mattdavis0351/actions/tree/v1.3.0/docker-gpr) action to store an image in Packages. 
...
4. Finally, add a Deploy-to-Azure job that waits for the Build-Docker-Image job, then deploys to Azure using the [azure/login](https://github.com/Azure/login/tree/v1), [azure/docker-login](https://github.com/Azure/docker-login/tree/v1), and [azure/webapps-deploy](https://github.com/Azure/webapps-deploy/tree/v2) actions before logging out of Azure with az logout. 

   <details><summary>The finished job should look like this:</summary>
...
<details><summary>If you'd like to copy the full workflow, it should look like this:</summary>
